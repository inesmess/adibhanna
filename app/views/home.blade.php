...
<section class="section" id="work">
	<div class="container">
		...
		<h2 class="text-center title">More work</h2>
...
<section class="section" id="contact">
	<div class="container">
		...
		<h2 class="text-center title">Hire Me</h2>

		<div class="row">
			<div class="col-sm-8 col-sm-offset-2 text-center">
				<!-- <p class="lead"></p> -->
				<p><b> <a href="mailto:adibhanna@gmail.com">adibhanna@gmail.com</a></b><br><br></p>
				<ul class="list-inline list-social">
					<li><a href="https://twitter.com/Adib_Hanna" target="_blank" class="btn btn-link"><i class="fa fa-twitter fa-fw"></i> Twitter</a></li>
